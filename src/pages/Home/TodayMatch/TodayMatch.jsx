...
const TodayMatch = () => {
    return (
        <div className='relative'>
            <p className='text-center text-9xl opacity-10 my-32 font-extrabold' style={{ letterSpacing: '10px' }}>LIVE</p>
            <div className="flex justify-between items-center my-16 w-full absolute bottom-0 top-0">
